...
Сценарий: Запись элемента плана видов характеристик "Виды характеристик" (ВидыХарактеристик)
	...
	Если 'ЗначениеЗаполнено($НавигационнаяСсылка$)' Тогда
		...
		* Записываем существующий элемент
			...
			Если элемент формы с именем 'ФормаЗаписать' присутствует на форме Тогда
				...
				Если появилось предупреждение Тогда
					Тогда я вызываю исключение "Не удалось записать существующий элемент плана видов характеристик ВидыХарактеристик"
				Если имя текущей формы "ErrorWindow" Тогда
					Тогда я вызываю исключение "Не удалось записать существующий элемент плана видов характеристик ВидыХарактеристик"
		...
		* Пересчитаем существующий элемент
			...
			Если элемент формы с именем 'ФормаПеречитать' присутствует на форме Тогда
				...
				Если появилось предупреждение Тогда
					Тогда я вызываю исключение "Не удалось перечитать существующий элемент плана видов характеристик ВидыХарактеристик"
				Если имя текущей формы "ErrorWindow" Тогда
					Тогда я вызываю исключение "Не удалось перечитать существующий элемент плана видов характеристик ВидыХарактеристик"
		...
		* Помечаем на удаление существующий элемент
			...
			Если элемент формы с именем 'ФормаУстановитьПометкуУдаления' присутствует на форме Тогда
				...
				Если появилось предупреждение Тогда
					Тогда я вызываю исключение "Не удалось пометить на удаление элемент плана видов характеристик ВидыХарактеристик"
				Если имя текущей формы "ErrorWindow" Тогда
					Тогда я вызываю исключение "Не удалось пометить на удаление элемент плана видов характеристик ВидыХарактеристик"
		...
		* Снимаем пометку на удаление с существующего элемента
			...
			Если элемент формы с именем 'ФормаУстановитьПометкуУдаления' присутствует на форме Тогда
				...
				Если открылось окно '1С:Предприятие' Тогда
					И я нажимаю на кнопку с именем 'Button0'
				Если появилось предупреждение Тогда
					Тогда я вызываю исключение "Не удалось снять пометку на удаление с элемента плана видов характеристик ВидыХарактеристик"
				Если имя текущей формы "ErrorWindow" Тогда
					Тогда я вызываю исключение "Не удалось снять пометку на удаление с элемента плана видов характеристик ВидыХарактеристик"
		...
		* Запишем и закроем существующий элемент
			...
			Если элемент формы с именем 'ФормаЗаписатьИЗакрыть' присутствует на форме Тогда
				...
				Если появилось предупреждение Тогда
					Тогда я вызываю исключение "Не удалось записать и закрыть элемент плана видов характеристик ВидыХарактеристик"
