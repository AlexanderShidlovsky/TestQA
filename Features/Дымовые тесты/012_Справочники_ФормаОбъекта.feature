...
Сценарий: Открытие формы справочника "История изменения данных (ОИД)" (оидИсторияИзмененияДанных)

	Дано Я открываю основную форму справочника "оидИсторияИзмененияДанных"
	Если появилось предупреждение Тогда
		Тогда я вызываю исключение "Не удалось открыть основную форму справочника оидИсторияИзмененияДанных"
	Если имя текущей формы "ErrorWindow" Тогда
		Тогда я вызываю исключение "Не удалось открыть основную форму справочника оидИсторияИзмененияДанных"
	И Я закрываю текущее окно
